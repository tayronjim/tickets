...
define('SECRET_SALT','aXnbyYZHUk6bY2Ffumqupigg28yM60P5');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','it@diazmorones.com');
...
define('DBUSER','dmhelpdesk');
define('DBPASS','Dma371');

# Table prefix
define('TABLE_PREFIX','helpdesk_');
